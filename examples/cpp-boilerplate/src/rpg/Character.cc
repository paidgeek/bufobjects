...
namespace rpg {
  ...
  inline Character &Character::operator=(const Character &from) {
    from.CopyTo(*this);
    return *this;
  }
  ...
  void Character::SetBuffs(std::array<double, 8> buffs) {
    buffs_ = buffs;
  }
  ...
  void Character::SetBuffsAt(int index, double value) {
    buffs_[index] = value;
  }
